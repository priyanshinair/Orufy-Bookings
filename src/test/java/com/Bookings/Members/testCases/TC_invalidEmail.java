...
public class TC_invalidEmail extends BaseClassMembers{
	...
	public void invalidEmail () throws InterruptedException {
		...
		String initialBorderColor = email.getCssValue("border-color");
		
		email.sendKeys("priyanshi@com");
		...
		if(!initialBorderColor.equals(borderColor)) {
			System.out.println("Border color changed!");
		}
		else {
			System.out.println("Border color didn't changed!");
		}
	}
}
